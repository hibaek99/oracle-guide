...
const STEPS = [
  ...
  },
  {
    label: "STEP 5",
    title: "고용24 수강신청",
    meta: "내일배움카드 필수 · 빠를수록 좋아요!",
    desc: "합격자 발표 후 고용24 홈페이지에서 수강신청을 진행해 주세요.\n💳 내일배움카드를 반드시 소지하셔야 합니다.\n⚡ 수강신청은 빠를수록 좋습니다!",
    howPath: ["고용24", "취업지원", "훈련 찾기·신청", "오라클 AI Campus 검색"],
    checks: [
      { yes: true,  main: "수강신청 완료",   sub: "→ 담당 매니저의 개강 안내를 기다려 주세요 👏" },
  ...
  },
  {
    ...
    title: "최종 합류",
    meta: "개강일 확정 후 개별 안내",
    desc: "<strong style='color: var(--purple-600'>고용24 수강신청까지 완료하셨다면 모든 절차가 끝났어요!</strong> 🎉\n 개강일 및 OT 일정은 담당 매니저가 개별 안내드립니다:)",
    extra: "💡 개강 전 사전 안내 사항을 문자로 발송드릴 예정입니다😊 개강일에 만나요!👏"
  }
];
